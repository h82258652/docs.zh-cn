...
| **标题** | IDE0007：使用“var”而不是显式类型<br/> IDE0008：使用显式类型而不是“var” |
| **类别** | Style |
| **Subcategory** | 语言规则 |
| **适用的语言** | C# |
...
本节中的样式规则与变量声明中的 [var](../../../csharp/language-reference/keywords/var.md) 关键字和显式类型的使用有关。 此规则可单独应用于内置类型、类型明显的位置和其他位置。
