...
---
# <a name="use-pattern-matching-to-avoid-as-followed-by-a-null-check-ide0019"></a>使用模式匹配来避免 as 后跟 null 检查 (IDE0019)
...
此样式规则涉及使用 C# [模式匹配](../../../csharp/pattern-matching.md)而不是后跟 `null` 检查的 `as` 表达式。
