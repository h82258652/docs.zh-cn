...
---
# <a name="remove-unnecessary-import-ide0005"></a>删除不必要的 import (IDE0005)
...
- C# 不必要的 [using static 指令](../../../csharp/language-reference/keywords/using-static.md)。
...
> [!NOTE]
> 若要[在生成时启用此规则](../overview.md#code-style-analysis)，需要为项目启用 [XML 文档注释](../../../csharp/codedoc.md)。 如需更多详细信息，请参阅[此问题](https://github.com/dotnet/roslyn/issues/41640)。
