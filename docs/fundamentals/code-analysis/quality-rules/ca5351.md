...
- 对于 MD5，请使用 [SHA-2](/windows/desktop/SecCrypto/hash-and-signature-algorithms) 系列中的哈希（例如 <xref:System.Security.Cryptography.SHA512>、<xref:System.Security.Cryptography.SHA384>、<xref:System.Security.Cryptography.SHA256>）。
