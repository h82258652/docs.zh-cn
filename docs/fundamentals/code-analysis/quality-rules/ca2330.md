...
此规则类似于 [CA2329](ca2329.md)，但无法通过分析明确确定序列化程序的配置是否不安全。
...
- 你已采取[如何解决冲突](#how-to-fix-violations)的某项预防措施。
- 你知道，当 [TypeNameHandling](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializerSettings_TypeNameHandling.htm) 属性是 `None` 以外的值时，将始终设置 [Newtonsoft.Json.JsonSerializer.SerializationBinder](https://www.newtonsoft.com/json/help/html/P_Newtonsoft_Json_JsonSerializer_SerializationBinder.htm) 属性。
