...
调用或引用了 <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> 反序列化方法，但 <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> 属性可能为 NULL。

此规则类似于 [CA2301](ca2301.md)，但分析无法确定 <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> 是否一定为 NULL。
